...
import (
	...
	_ "github.com/jinzhu/gorm/dialects/mysql" // needed for mysql gorm

	"github.com/hpcloud/catalog-templates/apps/stackato-mysql/common"
)
...
func dbConnection() (*gorm.DB, error) {
	...
	svcList, err := appEnv.Services.WithTag("stackato-mysql")
	if err != nil {
	...
	connectionString += "/" + database + "?charset=utf8&parseTime=True"
